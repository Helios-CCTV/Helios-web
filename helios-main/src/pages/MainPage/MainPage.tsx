  ...
  return (
    <>
      <div className='snap-y snap-mandatory h-screen overflow-y-scroll'>
        ...
        <div className='snap-start w-full h-screen'><ViewStatusEx/></div>
        <div className='snap-start w-full h-screen'><ViewStatus/></div>
        <div className='snap-start w-full h-screen'><DetectionResult/></div>
        <div className='snap-start w-full h-screen'><ReportService/></div>
      </div>      
    </>
  )
}
