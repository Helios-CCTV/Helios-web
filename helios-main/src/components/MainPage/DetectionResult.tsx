    ...
    <>
      <div className="w-full h-screen bg-gradient-to-br from-green-50 via-white to-blue-50 flex flex-col justify-center items-center py-20">
        ...
        <div className="text-center mb-16">
          <div className="font-[900] text-3xl lg:text-4xl text-gray-800 leading-tight mt-30">
            AI가 탐지한 결과를 모아봤어요.
          </div>
        </div>

        {/* 메인 컨텐츠 섹션 */}
        <div className="max-w-7xl mx-auto px-8 flex items-center justify-center gap-16 lg:gap-20">
          {/* 왼쪽 설명 */}
          <div className="flex-shrink-0">
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 max-w-xs">
              <div className="text-center mb-6">
                <div className="font-[700] text-lg text-gray-800 leading-relaxed">
                  <div>현재 도로가</div>
